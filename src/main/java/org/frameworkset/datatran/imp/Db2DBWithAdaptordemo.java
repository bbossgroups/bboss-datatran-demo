 ...
 * @version 1.0
 */
public class Db2DBWithAdaptordemo {
	private static final Logger logger = LoggerFactory.getLogger(Db2DBWithAdaptordemo.class);
	public static void main(String[] args){
		Db2DBWithAdaptordemo dbdemo = new Db2DBWithAdaptordemo();
...
//		dbdemo.scheduleImportData(dropIndice);
	...
	public void scheduleImportData(){
		...
		dbInputConfig.setDbName("source")
                ...
                .setDbAdaptor("org.frameworkset.datatran.imp.DruidAdaptor")
