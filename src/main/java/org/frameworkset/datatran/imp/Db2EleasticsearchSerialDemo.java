 ...
 * @version 1.0
 */
public class Db2EleasticsearchSerialDemo {
	private static Logger logger = LoggerFactory.getLogger(Db2EleasticsearchSerialDemo.class);
	public static void main(String args[]){
		Db2EleasticsearchSerialDemo db2EleasticsearchDemo = new Db2EleasticsearchSerialDemo();
