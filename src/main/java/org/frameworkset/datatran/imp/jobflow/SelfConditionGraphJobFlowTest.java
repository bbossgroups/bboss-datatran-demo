 ...
 * @Date 2025/6/22
 */
public class SelfConditionGraphJobFlowTest {
    private static Logger logger = LoggerFactory.getLogger(SelfConditionGraphJobFlowTest.class);
...
//        ImportBuilder importBuilder = build();
         ...
         * 1.2 构建自循环的条件有向循环图
         */
        jobFlowBuilder.addConditionJobFlowNodeBuilder(jobFlowNodeBuilder,nodeTrigger);
