...
import org.frameworkset.tran.jobflow.builder.CommonJobFlowNodeBuilder;
 ...
 * @Date 2025/6/22
 */
public class SelfParrelConditionGraphJobFlowTest {
    private static Logger logger = LoggerFactory.getLogger(SelfParrelConditionGraphJobFlowTest.class);
...
//        jobFlowScheduleConfig.setPeriod(1000000L);
         ...
         * 1.1 将节点添加到工作流构建器
         */
        jobFlowBuilder.addJobFlowNodeBuilder(subParrelJobFlowNodeBuilder);
        /**
         * 1.2 构建自循环的条件有向循环图
         */
        jobFlowBuilder.addConditionJobFlowNodeBuilder(subParrelJobFlowNodeBuilder,nodeTrigger);
