 ...
 * @version 1.0
 */
public class Db2EleasticsearchMetricsDemo {
	private static Logger logger = LoggerFactory.getLogger(Db2EleasticsearchMetricsDemo.class);
	public static void main(String args[]){
		Db2EleasticsearchMetricsDemo db2EleasticsearchDemo = new Db2EleasticsearchMetricsDemo();
            ...
            public void startAction(ImportContext importContext) {
                importContext.addResourceStart(new ResourceStart() {
                    ...
                    public ResourceStartResult startResource() {
                        ...
                        tempConf.setJdbcurl("jdbc:mysql://192.168.137.1:3306/bboss?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf-8&useSSL=false&rewriteBatchedStatements=true");
