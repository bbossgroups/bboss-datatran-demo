 ...
 * @version 1.0
 */
public class Db2MultiOutputDemo {
	private static final Logger logger = LoggerFactory.getLogger(Db2MultiOutputDemo.class);
	public static void main(String[] args){
		Db2MultiOutputDemo dbdemo = new Db2MultiOutputDemo();
