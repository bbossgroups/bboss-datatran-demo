 ...
 * @version 1.0
 */
public class Db2EleasticsearchTimestampDemo {
	private static Logger logger = LoggerFactory.getLogger(Db2EleasticsearchTimestampDemo.class);
	public static void main(String args[]){
		Db2EleasticsearchTimestampDemo db2EleasticsearchDemo = new Db2EleasticsearchTimestampDemo();
...
//		setFromfirst(true) 如果作业停了，作业重启后，重新开始采集数据
		...
		importBuilder.setLastValueStorePath("d:/logtabletmp_import");//记录上次采集的增量字段值的文件路径，作为下次增量（或者重启后）采集数据的起点，不同的任务这个路径要不一样
