 ...
 * @version 1.0
 */
public class Binlog2EleasticsearchOutput {
    private static Logger logger = LoggerFactory.getLogger(Binlog2EleasticsearchOutput.class);
...
//        mySQLBinlogConfig.setFileNames("F:\\6_environment\\mysql\\binlog.000107,F:\\6_environment\\mysql\\binlog.000127");
        mySQLBinlogConfig.setTables("cityperson");//
        ...
        elasticsearchOutputConfig
                ...
                .setIndex("dbdemo")
                .setEsIdField("log_id");//设置文档主键，不设置，则自动产生文档id,设置好id后，binlog采集的增删改数据，会自动同步到Elasticsearch
