 ...
 * @version 1.0
 */
public class Db2Clickhousedemo {
	private static final Logger logger = LoggerFactory.getLogger(Db2Clickhousedemo.class);
	public static void main(String[] args){
		Db2Clickhousedemo dbdemo = new Db2Clickhousedemo();
