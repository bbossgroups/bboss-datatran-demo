 ...
 * @version 1.0
 */
public class TestKeyMetrics {
	private static Logger logger = LoggerFactory.getLogger(TestKeyMetrics.class);
	public static void main(String[] args){
		...
		Metrics keyMetrics = new Metrics(Metrics.MetricsType_KeyMetircs) {
			...
			public void persistent(Collection< KeyMetric> metrics) {
				metrics.forEach(keyMetric->{
					...
					bulkProcessor.insertData("vops-testkeymetrics",esData);
