 ...
 * @version 1.0
 */
public class TestTimeKeyMetrics {
	private static Logger logger = LoggerFactory.getLogger(TestTimeKeyMetrics.class);
	public static void main(String[] args){
		...
		Metrics keyMetrics = new Metrics(Metrics.MetricsType_TimeKeyMetircs) {
			...
			public void persistent(Collection< KeyMetric> metrics) {
				metrics.forEach(keyMetric->{
					...
					bulkProcessor.insertData("vops-testtimekeymetrics",esData);
